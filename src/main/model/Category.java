...
public class Category {
    ...
    /*
     * REQUIRES: categoryName has a non-zero length; categoryWeight > 0; categoryMark >= 0
     ...
     */
    public Category(String categoryName, double categoryWeight, double categoryMark) {
        name = categoryName;
        weight = categoryWeight;
        mark = categoryMark;
        weightedMark = weight * mark;
    }
